...
#ifndef MIDAS_TASK_TASK_HPP
#define MIDAS_TASK_TASK_HPP
...
tasks/Task.cpp, and will be put in the midas namespace.
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','midas::Task')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Task(std::string const& name = "midas::Task");
    ...
    protected:
        void outputDepthMap(cv::Mat &image, const ::base::Time &timestamp);
